...
// SpeakingActivities is the ordered list of public speaking engagements shown
// on the speaking page and the home page. Most-recent first.
// To add a new talk, prepend a new SpeakingActivity to this slice.
var SpeakingActivities = []*SpeakingActivity{
	{
		...
		Extras: []SpeakingActivityExtra{
			{Name: "Slides", Link: "https://speakerdeck.com/tourismgeek/redis-cluster-for-write-intensive-workloads", IconCSSClasses: "area chart"},
			{Name: "Conference Profile", Link: "https://ndc-london.com/agenda/redis-cluster-for-write-intensive-workloads-0xcp/0e9ytrmxsf1", IconCSSClasses: "external link"},
			{Name: "Chosen Tweet", Link: "https://twitter.com/tourismgeek/status/1355095638929788929", IconCSSClasses: "twitter"},
		},
	},
	{
		...
		Extras: []SpeakingActivityExtra{
			{Name: "Slides", Link: "https://speakerdeck.com/tourismgeek/designing-towards-event-sourcing", IconCSSClasses: "area chart"},
			{Name: "Conference Profile", Link: "https://skillsmatter.com/skillscasts/13542-designing-towards-event-sourcing", IconCSSClasses: "external link"},
			{Name: "Chosen Tweet", Link: "https://twitter.com/tourismgeek/status/1134544999717187584", IconCSSClasses: "twitter"},
		},
	},
	{
	...
	<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/qpfFus69pN8" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		...
		Extras: []SpeakingActivityExtra{
			{Name: "Slides", Link: "https://speakerdeck.com/tourismgeek/essentials-for-building-and-leading-highly-effective-development-teams", IconCSSClasses: "area chart"},
			{Name: "Conference Profile", Link: "https://web.archive.org/web/20181108073211/http://devconf.pl/speakers/tugberk-ugurlu/", IconCSSClasses: "external link"},
			{Name: "Chosen Tweet", Link: "https://twitter.com/tourismgeek/status/1045282398181761026", IconCSSClasses: "twitter"},
		},
	},
	{
	...
	<iframe class="embed-responsive-item" src="https://player.vimeo.com/video/275529797?title=0&byline=0&portrait=0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
		...
		Extras: []SpeakingActivityExtra{
			{Name: "Slides", Link: "https://speakerdeck.com/tourismgeek/let-the-uncertainty-be-your-friend-finding-your-path-in-a-wiggly-road", IconCSSClasses: "area chart"},
			{Name: "Conference Profile", Link: "http://www.ncrafts.io/speaker/tourismgeek", IconCSSClasses: "external link"},
			{Name: "Chosen Tweet", Link: "https://twitter.com/tourismgeek/status/997107891063721985", IconCSSClasses: "twitter"},
		},
	},
	{
		...
		Extras: []SpeakingActivityExtra{
			{Name: "Slides", Link: "https://speakerdeck.com/tourismgeek/levelling-up-to-become-a-technical-lead", IconCSSClasses: "area chart"},
			{Name: "Chosen Tweet", Link: "https://twitter.com/tourismgeek/status/961963028651610117", IconCSSClasses: "twitter"},
		},
	},
	{
	...
	<iframe class="embed-responsive-item" src="https://player.vimeo.com/video/171317249?title=0&byline=0&portrait=0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
		...
		Extras: []SpeakingActivityExtra{
			{Name: "Slides", Link: "https://speakerdeck.com/tourismgeek/let-the-uncertainty-be-your-friend-finding-your-path-in-a-wiggly-road", IconCSSClasses: "area chart"},
			{Name: "Code", Link: "https://github.com/tugberkugurlu/AspNetCoreSamples/tree/ndcoslo2016/haproxy-zero-downtime-sample", IconCSSClasses: "code"},
			{Name: "Conference Profile", Link: "https://web.archive.org/web/20160530194908/https://ndcoslo.com/speaker/tugberk-ugurlu/", IconCSSClasses: "external link"},
			{Name: "Announcment Article", Link: "https://www.tugberkugurlu.com/archive/off-to-oslo-for-ndc-developer-conference", IconCSSClasses: "rss"},
			{Name: "Recap Article", Link: "https://www.tugberkugurlu.com/archive/ndc-oslo-2016-in-a-nutshell", IconCSSClasses: "rss"},
		},
	},
	{
	...
	<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/9a6gVaX192g" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		...
		Extras: []SpeakingActivityExtra{
			{Name: "Conference Profile", Link: "https://www.red-gate.com/hub/events/sqlinthecity/2017", IconCSSClasses: "external link"},
			{Name: "Announcment Article", Link: "https://www.tugberkugurlu.com/archive/speaking-at-sql-in-the-city-2017-register-now", IconCSSClasses: "rss"},
		},
	},
	{
	...
	<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/nswAIlgD4fU" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		...
		Extras: []SpeakingActivityExtra{
			{Name: "Slides", Link: "https://speakerdeck.com/tourismgeek/docker-changes-the-way-you-develop-and-release-your-scalable-solutions", IconCSSClasses: "area chart"},
			{Name: "Conference Profile", Link: "http://itakeunconf.com/speakers/tugberk-ugurlu/", IconCSSClasses: "external link"},
			{Name: "Announcment Article", Link: "http://itakeunconf.com/docker-zero-downtime-deployment-rules/", IconCSSClasses: "rss"},
		},
	},
	{
		Title:    "Getting Into the Zero Downtime Deployment World",
	...
	<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/mTZSvK6I3Xs" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		...
		Extras: []SpeakingActivityExtra{
			{Name: "Slides", Link: "https://speakerdeck.com/tourismgeek/getting-into-the-zero-downtime-deployment-world-1", IconCSSClasses: "area chart"},
			{Name: "Conference Profile", Link: "https://web.archive.org/web/20161003064950/http://devday.pl/", IconCSSClasses: "external link"},
		},
	},
	{
		...
		Extras: []SpeakingActivityExtra{
			{Name: "Slides", Link: "https://speakerdeck.com/tourismgeek/architecting-polyglot-persistent-solutions", IconCSSClasses: "area chart"},
			{Name: "Conference Profile", Link: "https://web.archive.org/web/20160318163414/https://www.devconf.co.za/", IconCSSClasses: "external link"},
			{Name: "Chosen Tweet", Link: "https://twitter.com/tourismgeek/status/707123586197295104", IconCSSClasses: "twitter"},
			{Name: "Announcment Article", Link: "https://www.tugberkugurlu.com/archive/upcoming-conferences-and-talks", IconCSSClasses: "rss"},
			{Name: "Recap Article", Link: "https://www.tugberkugurlu.com/archive/my-summary-of-devconf-2016", IconCSSClasses: "rss"},
		},
	},
	{
	...
	<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/OEZKXRWDv60" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		...
		Extras: []SpeakingActivityExtra{
			{Name: "Slides", Link: "https://speakerdeck.com/tourismgeek/profiling-net-server-applications", IconCSSClasses: "area chart"},
			{Name: "Conference Profile", Link: "https://www.tugberkugurlu.com/archive/my-talk-on-profiling--net-server-applications-from-umbraco-uk-festival-2015", IconCSSClasses: "external link"},
		},
	},
	{
	...
	<a href="https://skillsmatter.com/skillscasts/6401-aspdot-net-5-how-to-get-your-cheese-back#video" target="_blank">
		...
		Extras: []SpeakingActivityExtra{
			{Name: "Slides", Link: "https://speakerdeck.com/tourismgeek/asp-dot-net-5-how-to-get-your-cheese-back", IconCSSClasses: "area chart"},
			{Name: "Code", Link: "https://github.com/british-proverbs/british-proverbs-mvc-6/tree/0ca8143e19a76a43cceeafdcecd28f69007a9108", IconCSSClasses: "code"},
			{Name: "Conference Profile", Link: "https://skillsmatter.com/legacy_profile/tugberk-ugurlu", IconCSSClasses: "external link"},
			{Name: "Announcment Article", Link: "https://www.tugberkugurlu.com/archive/upcoming-conferences-that-i-am-speaking-at", IconCSSClasses: "rss"},
			{Name: "Recap Article", Link: "https://www.tugberkugurlu.com/archive/progressive--net-tutorials-2015-and-recording-videos-of-my-asp-net-5-talks", IconCSSClasses: "rss"},
		},
	},
}
