...
<p>
What would happen if we do the opposite though: issue a command against a Redis node which doesn't actually own the hash slot for the given key? Here is the answer:
</p>
