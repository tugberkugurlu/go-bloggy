...
<p>Same goes for your middlewares. You can naturally hook into logging system from your middleware thanks to <a href="http://www.tugberkugurlu.com/archive/exciting-things-about-asp-net-vnext-series-middlewares-and-per-request-dependency-injection">first class middleware DI support</a>.</p>
<div class="code-wrapper border-shadow-1">
