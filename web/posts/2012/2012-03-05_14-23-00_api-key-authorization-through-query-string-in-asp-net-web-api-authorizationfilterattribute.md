---
id: 82e3041c-c7f0-436c-a2ee-fe70b6999f8e
...
<h3>Confession</h3>
<p>@SoyUnEmilio has pointed out a very good topic <a href="https://www.tugberkugurlu.com/archive/api-key-authorization-through-query-string-in-asp-net-web-api-authorizationfilterattribute#2673">in his comment</a> and <a href="https://www.tugberkugurlu.com/archive/api-key-authorization-through-query-string-in-asp-net-web-api-authorizationfilterattribute#2674">I replied back to him</a>&nbsp;but I would like to make it clear inside the post itself, too.</p>
...
<p><a href="https://www.tugberkugurlu.com/Content/Images/UploadedByAuthors/wlw/API-Key-Authorization-Throug.NET-Web-API_1A5/apiKey.png"><img style="background-image: none; padding-left: 0px; padding-right: 0px; display: inline; padding-top: 0px; border: 0px;" title="apiKey" border="0" alt="apiKey" src="https://www.tugberkugurlu.com/Content/Images/UploadedByAuthors/wlw/API-Key-Authorization-Throug.NET-Web-API_1A5/apiKey_thumb.png" width="644" height="345" /></a></p>
